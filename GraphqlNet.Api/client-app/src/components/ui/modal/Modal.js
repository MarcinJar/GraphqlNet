...
export default function Modal({title = '', buttonTitle = 'Otwórz okno', children}) {
  ...
  return <>
    ...
    <div className={`fixed top-0 left-0 z-30 w-screen h-screen bg-black bg-opacity-60 backdrop-filter backdrop-blur-lg flex justify-center items-center  ` + (!isVisible && 'hidden')} 
